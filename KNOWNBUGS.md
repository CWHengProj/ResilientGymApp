...
# UX
- Should be clearing / setting a time limit for the emails function after pressing the send button
- Pop ups should not persist so long
- Should have a button to skip exercise / increment without saving the current workout
- Formatting for the exercise descriptions

# Dev QOL
- Website should be self pinging rather than relying on cronjobs externally
